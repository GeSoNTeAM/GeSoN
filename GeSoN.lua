...
NameBot = (DevAbs:get(GeSoN..'Abs:NameBot') or 'وطن')
--     Source GeSoN     --
...
if text and text:match('^'..(DevAbs:get(GeSoN..'Abs:NameBot') or "وطن")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAbs:get(GeSoN..'Abs:NameBot') or "وطن")..' ','')
end
...
local BotName = (DevAbs:get(GeSoN.."Abs:NameBot") or 'وطن')
...
NameBot = (DevAbs:get(GeSoN..'Abs:NameBot') or 'وطن')
local rnnni = {' كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' ',' اسمي القميل '..NameBot..' '}
...
if text and text == (DevAbs:get(GeSoN..'Abs:NameBot') or 'وطن') then 
NameBot = (DevAbs:get(GeSoN..'Abs:NameBot') or 'وطن')
...
local rnnni = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,rnnni, 1, 'md') 
local rnnni = {"مواححح افيش عافيههه😍🔥💗","امممووااهحح شهلعسل🥺🍯💘","مواححح،ءوفف اذوب🤤💗"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..rnnni[math.random(#rnnni)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local rnnni = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,rnnni, 1, 'md') 
local rnnni = {"تتعال ححب محتاجيك🙂🍭","تعال يولل استاذكك ايريدككك😒🔪","يمعوود تعاال يريدوكك🤕♥️","تعال لكك ديصيحوك😐🖤"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..rnnni[math.random(#rnnni)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local rnnni = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,rnnni, 1, 'md') 
local rnnni = { "تتعال ححب @"..username.." محتاجيك🙂🍭","تعال يولل @"..username.." استاذكك ايريدككك😒🔪","يمعوود @"..username.." تعاال يريدوكك🤕♥️","تعال لكك @"..username.." ديصيحوك😐🖤",}
Dev_Abs(msg.chat_id_, result.id_, 1,''..rnnni[math.random(#rnnni)], 1, 'html') 
else  
Dev_Abs(msg.chat_id_, msg.id_, 1, '-› العضو غير موجود في المجموعه', 1, 'md') 
end 
...
DevAbs:set(GeSoN..'Abs:NameBot',(DevAbs:get(GeSoN..'Name:Bot') or 'وطن'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
