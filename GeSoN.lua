------------------------------------------------
-- This Source Was Developed By @GGI55.--
...
DevId = Config.DevId
SudoIds = {Config.SudoIds,782717203,1634560089} or {Config.SudoIds,782717203,1634560089}
GeSoN = Config.GeSoN
...
local Status = DevAbs:sismember(GeSoN..'Abs:ManagerAll:',msg.sender_user_id_) 
...
local Status = DevAbs:sismember(GeSoN..'Abs:AdminAll:',msg.sender_user_id_) 
...
------ Vip Member All ------
function VipAll(msg) 
local Status = DevAbs:sismember(GeSoN..'Abs:VipAll:',msg.sender_user_id_) 
...
var = true  
elseif DevAbs:sismember(GeSoN..'Abs:ManagerAll:', user_id) then
var = true  
elseif DevAbs:sismember(GeSoN..'Abs:AdminAll:', user_id) then
var = true  
elseif DevAbs:sismember(GeSoN..'Abs:VipAll:', user_id) then
var = true  
...
DevAbs:del(GeSoN..'Abs:Text:GpTexts'..Abbs..data.chat_id_)
DevAbs:srem(GeSoN..'Abs:Manager:GpRedod'..data.chat_id_,Abbs)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Abbs = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevAbs:smembers(GeSoN..'Abs:Text:GpTexts'..Abbs..data.chat_id_)
...
if DevAbs:sismember(GeSoN.."Coomds"..msg.chat_id_,DEV_ABBAS) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrabs = DevAbs:get(GeSoN.."Comd:New:rt:Abs:"..DEV_ABBAS..msg.chat_id_)
if mrabs == "مميز" and VipMem(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '-›العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'GeSoN')..')'..' ❩\n-›تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
DevAbs:set(GeSoN.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ABBAS) 
...
if mrabs == "مميز" and VipMem(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '-›العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'GeSoN')..')'..' ❩\n-›تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
local inline = {{{text="-› المطور .",url="t.me/"..(dp.username_ or "rnnni")}}}
...
local GeSoNTeaM = '-›اهلا عزيزي ↫ '..AbsRank(msg)..' \n-›تم تفعيل التواصل بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, GeSoNTeaM, 14, string.len(msg.sender_user_id_))
...
if DevAbs:get(GeSoN..'Abs:Lock:NightClub'..msg.chat_id_) and msg.reply_to_message_id_ == 0 then
...
HttpsMsg = https.request('https://apiabs.ml/nightclub.php?Get=GeSoN&TokenBot='..TokenBot..'&Url='..UrlId)
...
local GeSoNTeaM =  DevAbs:smembers(GeSoN..'Abs:Text:GpTexts'..text..msg.chat_id_)
Dev_Abs(msg.chat_id_, msg.id_, 1, '['..GeSoNTeaM[math.random(#GeSoNTeaM)]..']' , 1, 'md')  
end
end
--     Source GeSoN     --
...
function GeSoNTeaM(extra,result,success)
...
getUser(msg.sender_user_id_, GeSoNTeaM)
end
end
--     Source GeSoN     --
text = msg.content_.text_
...
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = GeSoN,offset_ = 0,limit_ = 1},function(extra,abbas,success) 
...
if DevAbs:get(GeSoN.."Abs:Photo:BotWelcome") then AbsPhoto = DevAbs:get(GeSoN.."Abs:Photo:BotWelcome") elseif abbas.photos_[0] then AbsPhoto = abbas.photos_[0].sizes_[1].photo_.persistent_id_ else AbsPhoto = nil end 
...
if DevAbs:get('GeSoNTeaM:'..GeSoN.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevAbs:del('GeSoNTeaM:'..GeSoN..'id:user'..msg.chat_id_)  
Dev_Abs(msg.chat_id_, msg.id_, 1, '-›تم الغاء الامر', 1, 'md')
DevAbs:del('GeSoNTeaM:'..GeSoN.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAbs:del('GeSoNTeaM:'..GeSoN.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevAbs:get('GeSoNTeaM:'..GeSoN..'id:user'..msg.chat_id_)  
...
if text and Constructor(msg) then 
if DevAbs:get('GeSoNTeaM:'..GeSoN.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevAbs:del('GeSoNTeaM:'..GeSoN..'ids:user'..msg.chat_id_)  
Dev_Abs(msg.chat_id_, msg.id_, 1, '-›تم الغاء الامر', 1, 'md')
DevAbs:del('GeSoNTeaM:'..GeSoN.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAbs:del('GeSoNTeaM:'..GeSoN.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevAbs:get('GeSoNTeaM:'..GeSoN..'ids:user'..msg.chat_id_)  
...
NameBot = (DevAbs:get(GeSoN..'Abs:NameBot') or 'جيسون')
local GeSoNTeaM = {"لتكول بوت اسمي "..NameBot.." 😒🔪","اسمي القميل "..NameBot.." 😚♥️","عندي اسم تره 😒💔","صيحولي "..NameBot.." كافي بوت 😒🔪","انت البوت لك 😒💔"} 
Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM[math.random(#GeSoNTeaM)] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevAbs:get(GeSoN..'Abs:NameBot') or 'جيسون') 
local GeSoNTeaM = {"اسمي القميل "..NameBot.." 😚♥️","هلاا يروحيي وياكك "..NameBot.." 😻♥️"} 
Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM[math.random(#GeSoNTeaM)] , 1, 'html') 
return false
end
if text and text == (DevAbs:get(GeSoN..'Abs:NameBot') or 'جيسون') then 
NameBot = (DevAbs:get(GeSoN..'Abs:NameBot') or 'جيسون')
local GeSoNTeaM = {'😸♥️ هلا كلبي وياك '..NameBot..' تفضل','ترةه مصختهاا احجيي شرايد 😕😒💔','اطلقق واحدد يصيح '..NameBot..' 😻♥️','خبصتت امنةة شتريدد عااد 🤧😒💔'} 
Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM[math.random(#GeSoNTeaM)] , 1, 'html') 
return false 
end
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
GeSoNTeaM = '-›اول واحد يدز هذا السمايل يربح ↫ '..name
...
GeSoNTeaM = '-›مبروك لقد ربحت في اللعبه \n-›ارسل ↫ سمايلات للعب مره اخرى'
Dev_Abs(msg.chat_id_, msg.id_, 1,GeSoNTeaM, 1, 'md')
...
GeSoNTeaM = '-›اول واحد يرتبها يربح ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,GeSoNTeaM, 1, 'md')
return false
end end
if text == DevAbs:get(GeSoN..'Abs:GameNum'..msg.chat_id_) and not DevAbs:get(GeSoN..'Abs:Games:Ids'..msg.chat_id_) then
...
GeSoNTeaM = '-›اول واحد يحلها يربح ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,GeSoNTeaM, 1, 'md')
return false
end end
if text == DevAbs:get(GeSoN..'Abs:GameNum'..msg.chat_id_) and not DevAbs:get(GeSoN..'Abs:Games:Ids'..msg.chat_id_) then
...
GeSoNTeaM = '-›ما معنى هذا السمايل :؟ ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,GeSoNTeaM, 1, 'md')
return false
end end
...
name = string.gsub(name,'👩‍⚖️','👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👩‍⚖️👨‍⚖️👨‍⚖️')
name = string.gsub(name,'👨‍🎨','👩‍🎨👩‍🎨👨‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨')
GeSoNTeaM = '-›اول واحد يطلع المختلف يربح\n{'..name..'} '
Dev_Abs(msg.chat_id_, msg.id_, 1,GeSoNTeaM, 1, 'md')
return false
end end
...
GeSoNTeaM = '-›اكمل المثال التالي ↫ ['..name..']'
Dev_Abs(msg.chat_id_, msg.id_, 1,GeSoNTeaM, 1, 'md')
return false
end end
...
GeSoNTeaM = '-›اكمل المعادله التاليه ↫ ⤈\n{'..name..'} '
Dev_Abs(msg.chat_id_, msg.id_, 1,GeSoNTeaM, 1, 'md')
return false
end end
...
if DevAbs:get(GeSoN.."Abs:Left:Bot"..GeSoN) and not SecondSudo(msg) then
...
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),GeSoNTeaM)
end
end
--     Source GeSoN     --
...
-›[Developer](https://t.me/GGI55)
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
-›[Tws GeSoN](t.me/Erx3Bot)
]]
...
local DevText = DevAbs:get(GeSoN.."DevText")
if DevAbs:get(GeSoN.."Abs:ChId") then DevCh = '\n-›*Dev Ch* ↬ [@'..DevCh1..']' else DevCh = '' end
tdcli_function({ID="GetUser",user_id_=DevId},function(arg,dp) 
...
local GeSoNTeaM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,GeSoNTeaM, 1, 'md') 
local GeSoNTeaM = { "لكك جرجف @"..username.." احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش لكك فاشل @"..username.." لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","حبيبي @"..username.." راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪","دمشي لك @"..username.." ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع @"..username.." متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪",}
Dev_Abs(msg.chat_id_, result.id_, 1,''..GeSoNTeaM[math.random(#GeSoNTeaM)], 1, 'html') 
else  
Dev_Abs(msg.chat_id_, msg.id_, 1, '-›العضو غير موجود في المجموعه', 1, 'md') 
end 
end 
resolve_username(username,GeSoNTeaM)
end
end
--     Source GeSoN     --
...
local GeSoNTeaM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,GeSoNTeaM, 1, 'md') 
local GeSoNTeaM = {"لكك جرجف احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش فاشل لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","دمشي لك ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪","حبيبي راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..GeSoNTeaM[math.random(#GeSoNTeaM)], 1, 'md') 
end 
...
local GeSoNTeaM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,GeSoNTeaM, 1, 'md') 
local GeSoNTeaM = {"مواححح افيش عافيههه😍🔥💗","امممووااهحح شهلعسل🥺🍯💘","مواححح،ءوفف اذوب🤤💗"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..GeSoNTeaM[math.random(#GeSoNTeaM)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local GeSoNTeaM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,GeSoNTeaM, 1, 'md') 
local GeSoNTeaM = {"تتعال ححب محتاجيك🙂🍭","تعال يولل استاذكك ايريدككك😒🔪","يمعوود تعاال يريدوكك🤕♥️","تعال لكك ديصيحوك😐🖤"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..GeSoNTeaM[math.random(#GeSoNTeaM)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local GeSoNTeaM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,GeSoNTeaM, 1, 'md') 
local GeSoNTeaM = { "تتعال ححب @"..username.." محتاجيك🙂🍭","تعال يولل @"..username.." استاذكك ايريدككك😒🔪","يمعوود @"..username.." تعاال يريدوكك🤕♥️","تعال لكك @"..username.." ديصيحوك😐🖤",}
Dev_Abs(msg.chat_id_, result.id_, 1,''..GeSoNTeaM[math.random(#GeSoNTeaM)], 1, 'html') 
else  
Dev_Abs(msg.chat_id_, msg.id_, 1, '-›العضو غير موجود في المجموعه', 1, 'md') 
end 
...
if DevAbs:sismember(GeSoN..'Abs:ManagerAll:',result.sender_user_id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if DevAbs:sismember(GeSoN..'Abs:AdminAll:',result.sender_user_id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if DevAbs:sismember(GeSoN..'Abs:VipAll:',result.sender_user_id_) then
...
DevAbs:srem(GeSoN..'Abs:ManagerAll:', result.sender_user_id_)
DevAbs:srem(GeSoN..'Abs:AdminAll:', result.sender_user_id_)
DevAbs:srem(GeSoN..'Abs:VipAll:', result.sender_user_id_)
...
sudobot = 'المطورين • ' else sudobot = '' end
if DevAbs:sismember(GeSoN..'Abs:ManagerAll:',result.id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if DevAbs:sismember(GeSoN..'Abs:AdminAll:',result.id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if DevAbs:sismember(GeSoN..'Abs:VipAll:',result.id_) then
vpall = 'المميزين العامين • ' else vpall = '' end
...
DevAbs:srem(GeSoN..'Abs:ManagerAll:', result.id_)
DevAbs:srem(GeSoN..'Abs:AdminAll:', result.id_)
DevAbs:srem(GeSoN..'Abs:VipAll:', result.id_)
...
DevAbs:sadd(GeSoN..'Abs:ManagerAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(GeSoN..'Abs:ManagerAll:',result.id_)
...
DevAbs:sadd(GeSoN..'Abs:ManagerAll:',user)
...
DevAbs:srem(GeSoN..'Abs:ManagerAll:',user)
...
function raf_reply(extra, result, success)
DevAbs:sadd(GeSoN..'Abs:AdminAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(GeSoN..'Abs:AdminAll:',result.id_)
...
DevAbs:sadd(GeSoN..'Abs:AdminAll:',user)
...
DevAbs:srem(GeSoN..'Abs:AdminAll:',user)
...
function raf_reply(extra, result, success)
DevAbs:sadd(GeSoN..'Abs:VipAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(GeSoN..'Abs:VipAll:',result.id_)
...
DevAbs:sadd(GeSoN..'Abs:VipAll:',user)
...
DevAbs:srem(GeSoN..'Abs:VipAll:',user)
...
function prom_reply(extra, result, success)
if not BasicConstructor(msg) and DevAbs:get(GeSoN.."Abs:Lock:ProSet"..msg.chat_id_) then 
...
if text == "راسلني" then
GeSoNTeaM = {"ها هلاو","انطق","كول حبي","تفضل"};
send(msg.sender_user_id_, 0,GeSoNTeaM[math.random(#GeSoNTeaM)])
end
--     Source GeSoN     --
...
if DevAbs:sismember(GeSoN..'Abs:SecondSudo:',result.sender_user_id_) and not Sudo(msg) then
...
if DevAbs:sismember(GeSoN..'Abs:SecondSudo:',result.id_) and not Sudo(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, "-›*لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
if result.id_ then
...
if DevAbs:sismember(GeSoN..'Abs:SecondSudo:',user) and not Sudo(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, "-›*لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
...
DevAbs:set('GeSoNTeaM:'..GeSoN..'id:user'..msg.chat_id_,TXT)  
DevAbs:setex('GeSoNTeaM:'..GeSoN.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevAbs:set('GeSoNTeaM:'..GeSoN..'ids:user'..msg.chat_id_,TXT)  
DevAbs:setex('GeSoNTeaM:'..GeSoN.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
if DevAbs:get(GeSoN..'Abs:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ then if msg.reply_to_message_id_ ~= 0 then DevAbs:sadd(GeSoN.."Abs:cleaner"..msg.chat_id_, msg.id_) else DevAbs:sadd(GeSoN.."Abs:cleaner"..msg.chat_id_, msg.id_) end end end
...
local List = DevAbs:smembers(GeSoN..'Abs:ManagerAll:')
...
local List = DevAbs:smembers(GeSoN..'Abs:VipAll:')
...
sudobot = '\n-›عدد الكروبات ↫ '..(DevAbs:get(GeSoN..'Abs:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
sudobot = '\n-›عدد الكروبات ↫ '..(DevAbs:get(GeSoN..'Abs:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
sudobot = '\n-›عدد الكروبات ↫ '..(DevAbs:get(GeSoN..'Abs:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
DevAbs:set("GeSoN:New:id:"..GeSoN..msg.sender_user_id_,'GeSoNTeaM')
return "GeSoNTeaM"
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '-›رجائا اتبع التعليمات للتعيين \n-›لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉', 1, 'md')
DevAbs:set("GeSoN:New:id:"..GeSoN..msg.chat_id_..msg.sender_user_id_,'GeSoNTeaM')
return "GeSoNTeaM"
end
...
function GeSoNTeaM(extra,abbas,success)
...
if not DevAbs:get(GeSoN..'Abs:Lock:NightClub'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","-›تم قفل الاباحي")  
DevAbs:set(GeSoN..'Abs:Lock:NightClub'..msg.chat_id_,true)
else
...
changeChatMemberStatus(group[i], GeSoN, "Left")
w = w + 1
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1,'-›عدد الكروبات الان ↫ { '..#group..' }'..GeSoNgp1..GeSoNgp2..'\n-›العدد الحقيقي الان  ↫ ( '..GeSoNgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
if msg and DevAbs:get(GeSoN..'Abs:Lock:Clean'..msg.chat_id_) then
...
if DevAbs:scard(GeSoN.."Abs:cleaner"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = DevAbs:smembers(GeSoN.."Abs:cleaner"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
...
if DevAbs:get(GeSoN..'Abs:Lock:NightClub'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","-›تم فتح الاباحي")  
DevAbs:del(GeSoN..'Abs:Lock:NightClub'..msg.chat_id_)
else
...
DevAbs:del(GeSoN..'Abs:ManagerAll:')
end
...
if DevAbs:get(GeSoN..'Abs:Lock:NightClub'..msg.chat_id_) then mute_nightclub = 'مقفل' else mute_nightclub = 'مفتوح' end
...
if text and text:match("^انطق (.*)$") and not DevAbs:get(GeSoN..'Abs:Antk:Abs'..msg.chat_id_) then
...
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and DevAbs:get(GeSoN..'HataNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and DevAbs:get(GeSoN..'RjolaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and DevAbs:get(GeSoN..'AnothaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and DevAbs:get(GeSoN..'StupidNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text == "الروابط" then if DevAbs:get(GeSoN..'Abs:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local GeSoNTeaM = "\n" .."-›الروابط ↫ "..mute_links.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevAbs:get(GeSoN..'Abs:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local GeSoNTeaM = "\n" .."-›المعرف ↫ "..lock_tag.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevAbs:get(GeSoN..'Abs:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local GeSoNTeaM = "\n" .."-›المتحركه ↫ "..mute_gifs.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "الملصقات" then if DevAbs:get(GeSoN..'Abs:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local GeSoNTeaM = "\n" .."-›الملصقات ↫ "..lock_sticker.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "الصور" then if DevAbs:get(GeSoN..'Abs:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local GeSoNTeaM = "\n" .."-›الصور ↫ "..mute_photo.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevAbs:get(GeSoN..'Abs:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local GeSoNTeaM = "\n" .."-›الفيديو ↫ "..mute_video.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "الاونلاين" then if DevAbs:get(GeSoN..'Abs:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local GeSoNTeaM = "\n" .."-›الاونلاين ↫ "..mute_in.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "الدردشه" then if DevAbs:get(GeSoN..'Abs:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local GeSoNTeaM = "\n" .."-›الدردشه ↫ "..mute_text.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevAbs:get(GeSoN..'Abs:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local GeSoNTeaM = "\n" .."-›التوجيه ↫ "..lock_forward.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "الاغاني" then if DevAbs:get(GeSoN..'Abs:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local GeSoNTeaM = "\n" .."-›الاغاني ↫ "..mute_music.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevAbs:get(GeSoN..'Abs:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local GeSoNTeaM = "\n" .."-›الصوت ↫ "..mute_voice.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevAbs:get(GeSoN..'Abs:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local GeSoNTeaM = "\n" .."-›الجهات ↫ "..lock_contact.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "الماركداون" then if DevAbs:get(GeSoN..'Abs:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local GeSoNTeaM = "\n" .."-›الماركداون ↫ "..markdown.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "الهاشتاك" then if DevAbs:get(GeSoN..'Abs:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local GeSoNTeaM = "\n" .."-›الهاشتاك ↫ "..lock_htag.."\n"Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "التعديل" then if DevAbs:get(GeSoN..'Abs:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local GeSoNTeaM = "\n" .."-›التعديل ↫ "..mute_edit.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "التثبيت" then if DevAbs:get(GeSoN..'Abs:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local GeSoNTeaM = "\n" .."-›التثبيت ↫ "..lock_pin.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "الاشعارات" then if DevAbs:get(GeSoN..'Abs:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local GeSoNTeaM = "\n" .."-›الاشعارات ↫ "..lock_tgservice.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "الكلايش" then if DevAbs:get(GeSoN..'Abs:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local GeSoNTeaM = "\n" .."-›الكلايش ↫ "..lock_spam.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "الدخول" then if DevAbs:get(GeSoN..'Abs:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local GeSoNTeaM = "\n" .."-›الدخول ↫ "..lock_Join.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "الشبكات" then if DevAbs:get(GeSoN..'Abs:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local GeSoNTeaM = "\n" .."-›الشبكات ↫ "..lock_wp.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "المواقع" then if DevAbs:get(GeSoN..'Abs:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local GeSoNTeaM = "\n" .."-›المواقع ↫ "..lock_location.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "العربيه" then if DevAbs:get(GeSoN..'Abs:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local GeSoNTeaM = "\n" .."-›العربيه ↫ "..lock_arabic.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "الانكليزيه" then if DevAbs:get(GeSoN..'Abs:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local GeSoNTeaM = "\n" .."-›الانكليزيه ↫ "..lock_english.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "الكفر" then if DevAbs:get(GeSoN..'Abs:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local GeSoNTeaM = "\n" .."-›الكفر ↫ "..lock_kaf.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "الفشار" then if DevAbs:get(GeSoN..'Abs:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local GeSoNTeaM = "\n" .."-›الفشار ↫ "..lock_fshar.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
if text == "الطائفيه" then if DevAbs:get(GeSoN..'Abs:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local GeSoNTeaM = "\n" .."-›الطائفيه ↫ "..lock_taf.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, GeSoNTeaM, 1, 'md') end
end
--     Source GeSoN     --
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/GeSoN' end
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './GeSoN.lua', '-›نسخة ملف سورس جيسون',dl_cb, nil)
end end
--     Source GeSoN     --
...
return false end
if text and text:match("^(.*)$") then
local GeSoNTeaM =  DevAbs:get(GeSoN..'Abs:Help0'..msg.sender_user_id_)
if GeSoNTeaM == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local GeSoNTeaM =  DevAbs:get(GeSoN..'Abs:Help01'..msg.sender_user_id_)
if GeSoNTeaM == 'msg' then 
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local GeSoNTeaM =  DevAbs:get(GeSoN..'Abs:Help21'..msg.sender_user_id_)
if GeSoNTeaM == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local GeSoNTeaM =  DevAbs:get(GeSoN..'Abs:Help31'..msg.sender_user_id_)
if GeSoNTeaM == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local GeSoNTeaM =  DevAbs:get(GeSoN..'Abs:Help41'..msg.sender_user_id_)
if GeSoNTeaM == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local GeSoNTeaM =  DevAbs:get(GeSoN..'Abs:Help51'..msg.sender_user_id_)
if GeSoNTeaM == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local GeSoNTeaM =  DevAbs:get(GeSoN..'Abs:Help61'..msg.sender_user_id_)
if GeSoNTeaM == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
if DevAbs:get(GeSoN.."DevAbs2") then
DevAbs:set(GeSoN.."Abs:ChId",DevAbs:get(GeSoN.."DevAbs2"))
DevAbs:del(GeSoN.."DevAbs2")
end
if DevAbs:get(GeSoN.."Abs:textch:user") then
DevAbs:set(GeSoN.."Abs:ChText",DevAbs:get(GeSoN.."Abs:textch:user"))
DevAbs:del(GeSoN.."Abs:textch:user")
end
--     Source GeSoN     --
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '-›Channel ↬ [@rnnni]', 1, 'md')    
end 
--     Source GeSoN     --
if Sudo(msg) then 
...
if DevAbs:get(GeSoN..'Abs:Lock:EditMsgs'..msg.chat_id_) and not Text and not BasicConstructor(result) then
